# R Commands for Causal Inference

## R Commands

This document contains some example code blocks, that can be used with
the exercise on the `bcrot` dataset.
...
The below gives histograms comparing quality of life under hormone
...
Make sure you put in the right entry for the right-hand side of the
formula, and for the `data` argument!
